    ...
    public function run(): void
    {
        ...
        $packages = [
            [
                ...
                'table_limit' => 10,
                'waiter_limit' => 3,
                'features' => ['Up to 10 tables', 'Up to 3 waiters', 'QR ordering', 'Basic analytics', 'Email support'],
                'capabilities' => [],
                'is_featured' => false,
                'is_active' => true,
                'sort_order' => 1,
            ...
            [
                ...
                'table_limit' => null,
                'waiter_limit' => null,
                'features' => ['Unlimited tables', 'Unlimited waiters', 'TipTap Rafiki', 'Mobile money payments', 'Kitchen display', 'Priority support'],

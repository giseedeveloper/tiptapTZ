<x-manager-layout>
    <x-slot name="header">All Branches Overview</x-slot>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div class="glass-card rounded-2xl p-6 card-hover relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <p class="text-xs text-white/40 mt-1 uppercase tracking-wide">Across all branches</p>
            </div>
        </div>
        ...
        <div class="glass-card rounded-2xl p-6 card-hover relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <p class="text-xs text-white/40 mt-1 uppercase tracking-wide">Combined earnings</p>
            </div>
        </div>
        ...
        <div class="glass-card rounded-2xl p-6 card-hover relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <p class="text-xs text-white/40 mt-1 uppercase tracking-wide">Active right now</p>
            </div>
        </div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <h2 class="text-xl sm:text-2xl font-bold text-white tracking-tight">Your Branches</h2>
            <p class="text-xs text-white/40 uppercase tracking-wide mt-0.5">
                {{ $totals['branches'] }} {{ Str::plural('branch', $totals['branches']) }} total
            </p>
        </div>

<x-guest-layout title="TIPTAP | Register Waiter">
    <div class="relative max-w-[420px] mx-auto w-full">
        <div class="text-center mb-7">
            <h1 class="text-[1.65rem] sm:text-3xl font-black text-[#12141C] tracking-tight leading-tight">Register as Waiter</h1>
            <p class="text-[#64708B] font-medium mt-2 text-sm">Get your unique number — a manager will link you to a restaurant</p>
        </div>

        <x-auth-social-providers intent="register" role="waiter" locale="en" />
        ...
        <form method="POST" action="{{ route('waiter.register.credentials') }}" class="space-y-5">
            @csrf
            ...
            <div class="group space-y-2">
                <label for="password_confirmation" class="text-sm font-semibold text-[#12141C]">Confirm password</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#64708B]/45 group-focus-within:text-[#8C71F6] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <p class="mt-8 text-center text-sm text-[#64708B] leading-relaxed">

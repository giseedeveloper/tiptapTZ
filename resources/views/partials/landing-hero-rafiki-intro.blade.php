...
@if (filled($landing['hero']['rafiki_intro']))
    <div class="hero-rafiki-intro mb-5 max-w-lg mx-auto lg:mx-0">
        <div class="flex items-start gap-3 rounded-2xl border border-fin-primary/15 bg-white/75 px-4 py-3.5 shadow-sm backdrop-blur-sm">
            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-linear-to-br from-fin-primary to-fin-primary-dark shadow-md shadow-fin-primary/20">
                <img src="{{ asset('images/logo-64.png') }}" alt="" width="24" height="24" class="h-6 w-6 rounded-md bg-white object-contain p-0.5" aria-hidden="true">
            </span>
